...
$string['cachedef_recommendations'] = 'Données de recommandations de cours en cache';
...
$string['errorrating'] = 'Erreur, vous ne pouvez pas évaluer maintenant. Veuillez réessayer plus tard.';
...
$string['privacy:metadata:local_datacurso_ratings'] = 'Stocke les évaluations et commentaires des utilisateurs sur les modules de cours.';
...
$string['privacy:metadata:local_datacurso_ratings:feedback'] = 'Commentaire textuel facultatif fourni avec l’évaluation.';
$string['privacy:metadata:local_datacurso_ratings:rating'] = 'La valeur numérique de l’évaluation fournie par l’utilisateur.';
$string['privacy:metadata:local_datacurso_ratings:timecreated'] = 'La date à laquelle l’évaluation a été créée.';
$string['privacy:metadata:local_datacurso_ratings:timemodified'] = 'La date à laquelle l’évaluation a été modifiée pour la dernière fois.';
$string['privacy:metadata:local_datacurso_ratings:userid'] = 'L’ID de l’utilisateur ayant soumis l’évaluation.';
$string['privacy:metadata:local_datacurso_ratings_feedback'] = 'Stocke les types de commentaires généraux et leur classification.';
$string['privacy:metadata:local_datacurso_ratings_feedback:feedbacktext'] = 'Le texte du commentaire.';
$string['privacy:metadata:local_datacurso_ratings_feedback:timecreated'] = 'La date à laquelle le commentaire a été créé.';
$string['privacy:metadata:local_datacurso_ratings_feedback:timemodified'] = 'La date à laquelle le commentaire a été modifié pour la dernière fois.';
