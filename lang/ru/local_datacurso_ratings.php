...
$string['cachedef_recommendations'] = 'Кешированные данные рекомендаций курсов';
...
$string['errorrating'] = 'Ошибка: сейчас вы не можете поставить оценку. Попробуйте позже.';
...
$string['print'] = 'Печать';
$string['privacy:metadata:local_datacurso_ratings'] = 'Хранит оценки и комментарии пользователей к модулям курса.';
...
$string['privacy:metadata:local_datacurso_ratings:feedback'] = 'Необязательный текстовый комментарий, предоставленный вместе с оценкой.';
$string['privacy:metadata:local_datacurso_ratings:rating'] = 'Числовое значение оценки, предоставленное пользователем.';
...
$string['privacy:metadata:local_datacurso_ratings:userid'] = 'ID пользователя, который оставил оценку.';
$string['privacy:metadata:local_datacurso_ratings_feedback'] = 'Хранит типы отзывов и классификацию комментариев.';
$string['privacy:metadata:local_datacurso_ratings_feedback:feedbacktext'] = 'Текст комментария отзыва.';
$string['privacy:metadata:local_datacurso_ratings_feedback:timecreated'] = 'Время создания отзыва.';
$string['privacy:metadata:local_datacurso_ratings_feedback:timemodified'] = 'Время последнего изменения отзыва.';
$string['privacy:metadata:local_datacurso_ratings_feedback:type'] = 'Показывает, является ли отзыв положительным или отрицательным.';
...
$string['satisfaction'] = 'Уровень удовлетворенности';
...
$string['task_updaterecommendationscache'] = 'Обновить кеш рекомендаций курсов';
$string['total'] = 'всего';
